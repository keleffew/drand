...
type DKGControlClient interface {
	StartNetwork(ctx context.Context, in *FirstProposalOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartProposal(ctx context.Context, in *ProposalOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartAbort(ctx context.Context, in *AbortOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartExecute(ctx context.Context, in *ExecutionOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartJoin(ctx context.Context, in *JoinOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartAccept(ctx context.Context, in *AcceptOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	StartReject(ctx context.Context, in *RejectOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error)
...
func (c *dKGControlClient) StartNetwork(ctx context.Context, in *FirstProposalOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartProposal(ctx context.Context, in *ProposalOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartAbort(ctx context.Context, in *AbortOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartExecute(ctx context.Context, in *ExecutionOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartJoin(ctx context.Context, in *JoinOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartAccept(ctx context.Context, in *AcceptOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGControlClient) StartReject(ctx context.Context, in *RejectOptions, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
type DKGControlServer interface {
	StartNetwork(context.Context, *FirstProposalOptions) (*GenericResponseMessage, error)
	StartProposal(context.Context, *ProposalOptions) (*GenericResponseMessage, error)
	StartAbort(context.Context, *AbortOptions) (*GenericResponseMessage, error)
	StartExecute(context.Context, *ExecutionOptions) (*GenericResponseMessage, error)
	StartJoin(context.Context, *JoinOptions) (*GenericResponseMessage, error)
	StartAccept(context.Context, *AcceptOptions) (*GenericResponseMessage, error)
	StartReject(context.Context, *RejectOptions) (*GenericResponseMessage, error)
...
func (UnimplementedDKGControlServer) StartNetwork(context.Context, *FirstProposalOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartNetwork not implemented")
}
func (UnimplementedDKGControlServer) StartProposal(context.Context, *ProposalOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartProposal not implemented")
}
func (UnimplementedDKGControlServer) StartAbort(context.Context, *AbortOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartAbort not implemented")
}
func (UnimplementedDKGControlServer) StartExecute(context.Context, *ExecutionOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartExecute not implemented")
}
func (UnimplementedDKGControlServer) StartJoin(context.Context, *JoinOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartJoin not implemented")
}
func (UnimplementedDKGControlServer) StartAccept(context.Context, *AcceptOptions) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartAccept not implemented")
}
func (UnimplementedDKGControlServer) StartReject(context.Context, *RejectOptions) (*GenericResponseMessage, error) {
...
type DKGClient interface {
	Propose(ctx context.Context, in *ProposalTerms, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	Abort(ctx context.Context, in *AbortDKG, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	Execute(ctx context.Context, in *StartExecution, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	Accept(ctx context.Context, in *AcceptProposal, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	Reject(ctx context.Context, in *RejectProposal, opts ...grpc.CallOption) (*GenericResponseMessage, error)
	// BroadcastPacket is used during DKG phases
	BroadcastDKG(ctx context.Context, in *DKGPacket, opts ...grpc.CallOption) (*GenericResponseMessage, error)
}
...
func (c *dKGClient) Propose(ctx context.Context, in *ProposalTerms, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGClient) Abort(ctx context.Context, in *AbortDKG, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGClient) Execute(ctx context.Context, in *StartExecution, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGClient) Accept(ctx context.Context, in *AcceptProposal, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGClient) Reject(ctx context.Context, in *RejectProposal, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
func (c *dKGClient) BroadcastDKG(ctx context.Context, in *DKGPacket, opts ...grpc.CallOption) (*GenericResponseMessage, error) {
	out := new(GenericResponseMessage)
...
type DKGServer interface {
	Propose(context.Context, *ProposalTerms) (*GenericResponseMessage, error)
	Abort(context.Context, *AbortDKG) (*GenericResponseMessage, error)
	Execute(context.Context, *StartExecution) (*GenericResponseMessage, error)
	Accept(context.Context, *AcceptProposal) (*GenericResponseMessage, error)
	Reject(context.Context, *RejectProposal) (*GenericResponseMessage, error)
	// BroadcastPacket is used during DKG phases
	BroadcastDKG(context.Context, *DKGPacket) (*GenericResponseMessage, error)
}
...
func (UnimplementedDKGServer) Propose(context.Context, *ProposalTerms) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Propose not implemented")
}
func (UnimplementedDKGServer) Abort(context.Context, *AbortDKG) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Abort not implemented")
}
func (UnimplementedDKGServer) Execute(context.Context, *StartExecution) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Execute not implemented")
}
func (UnimplementedDKGServer) Accept(context.Context, *AcceptProposal) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Accept not implemented")
}
func (UnimplementedDKGServer) Reject(context.Context, *RejectProposal) (*GenericResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Reject not implemented")
}
func (UnimplementedDKGServer) BroadcastDKG(context.Context, *DKGPacket) (*GenericResponseMessage, error) {
